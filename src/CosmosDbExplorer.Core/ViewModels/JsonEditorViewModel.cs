...
namespace CosmosDbExplorer.ViewModels
{
    ...
    {
        protected JsonEditorViewModelBase(IEventAggregator messenger) : base(messenger)
        {
    ...
    {
        public JsonViewerViewModel(IEventAggregator messenger) : base(messenger)
        {
        }
    ...
    public class DocumentEditorViewModel : JsonViewerViewModel
    {
        ...
        public DocumentEditorViewModel(IEventAggregator messenger) : base(messenger)
        {
        }
    ...
    {
        public HeaderEditorViewModel(IEventAggregator messenger) : base(messenger)
        {
        }
