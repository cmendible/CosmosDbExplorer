        ...
        public RelayCommand AddUserCommand
        {
            get
            {
                return _addUserCommand ?? (_addUserCommand = new RelayCommand(
                    () => MessengerInstance.GetEvent<EditUserMessage>().Publish(new OpenTabMessageBase<UserNodeViewModel>(new UserNodeViewModel(new User(), this), Parent.Parent.Connection, null))
                    ));
            }
        }
