            ...
            get
            {
                return _openCommand
                    ?? (_openCommand = new RelayCommand(
                        () => {
                            IsSelected = false;
                            MessengerInstance.GetEvent<OpenCollectionMetricsViewMessage>().Publish(new OpenTabMessageBase<CollectionMetricsNodeViewModel>(this, Parent.Parent.Parent.Connection, Parent.Collection));
                        }));
            }
        }
