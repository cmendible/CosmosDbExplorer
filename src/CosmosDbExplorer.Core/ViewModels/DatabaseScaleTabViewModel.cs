...
namespace CosmosDbExplorer.ViewModels
{
    ...
    public class DatabaseScaleTabViewModel : PaneWithZoomViewModel<DatabaseScaleNodeViewModel>
    {
        ...
        public DatabaseScaleTabViewModel(IEventAggregator messenger, IDialogService dialogService, IDocumentDbService dbService, IUIServices uiServices, ThroughputViewModel throughput)
