...
namespace CosmosDbExplorer.ViewModel
{
    ...
    public class AccountSettingsViewModel : WindowViewModelBase
    {
        ...
        public AccountSettingsViewModel(IEventAggregator messenger, IDialogService dialogService, ISettingsService settingsService, IUIServices uiServices)
                    ...
                    ?? (_addAccountCommand = new RelayCommand(
                        async () =>
                        {
                            try
                            {
                                ...
                                MessengerInstance.GetEvent<ConnectionSettingSavedMessage>().Publish(connection);
