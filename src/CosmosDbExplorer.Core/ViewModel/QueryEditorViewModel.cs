...
namespace CosmosDbExplorer.ViewModel
{
        ...
        , IHaveSystemProperties
    {
        ...
        public QueryEditorViewModel(IEventAggregator messenger, IDocumentDbService dbService, IDialogService dialogService, IUIServices uiServices)
            : base(messenger, uiServices)
        {
            //EditorViewModel = ServiceLocator.Current.GetInstanceWithoutCaching<JsonViewerViewModel>();
            EditorViewModel = ServiceLocator.Current.GetInstance<JsonViewerViewModel>();
