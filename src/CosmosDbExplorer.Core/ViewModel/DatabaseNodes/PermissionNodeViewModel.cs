        ...
        public RelayCommand OpenCommand
        {
            get
            {
                return _openCommand ?? (_openCommand = new RelayCommand(
                    () => MessengerInstance.GetEvent<EditPermissionMessage>().Publish(new OpenTabMessageBase<PermissionNodeViewModel>(this, Parent.Parent.Parent.Parent.Connection, null))
                    ));
            }
        }
    }
