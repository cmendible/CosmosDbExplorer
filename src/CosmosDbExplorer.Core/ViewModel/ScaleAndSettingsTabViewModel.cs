...
namespace CosmosDbExplorer.ViewModel
{
    ...
    public class ScaleAndSettingsTabViewModel : PaneWithZoomViewModel<ScaleSettingsNodeViewModel>
    {
        ...
        public ScaleAndSettingsTabViewModel(IEventAggregator messenger, IDialogService dialogService, IDocumentDbService dbService, IUIServices uiServices, ThroughputViewModel throughput)
